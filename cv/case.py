...
# Bar plot for purchase revenue by country
...
# Histogram for distributoin of purchase revenues
plt.figure(figsize=(12, 6))
...
# Line chart for number of purchases over time
...
# Scatterplot for session counts vs. purchase counts for each user
...
# Box plot for distribution of purchase revenues by country
plt.figure(figsize=(12, 6))
